...
class OpenAIServingCompletion(OpenAIServing):
    ...
    async def create_completion(self, request: CompletionRequest,
        ...
        try:
            ...
            #     text = choice.text
            #     choice.text = self.tokenizer.batch_decode(text.cpu(), skip_special_tokens=True)
        except ValueError as e:
            # TODO: Use a vllm-specific Validation Error
            return self.create_error_response(str(e))
    ...
    def request_output_to_completion_response(
        ...
        for final_res in final_res_batch:
            ...
            print("final_res.outputs:",final_res.outputs)
            ...
            for output in final_res.outputs:
                ...
                # tensor_data = torch.tensor(token_ids, dtype=torch.long)
                # tensor_token_ids = tokenizer.batch_decode(tensor_data.cpu(), skip_special_tokens=True)
                # print("token_ids_after_Decode:",tensor_token_ids)
                ...
                # output_text = tokenizer.batch_decode(output_text.cpu(), skip_special_tokens=True)
